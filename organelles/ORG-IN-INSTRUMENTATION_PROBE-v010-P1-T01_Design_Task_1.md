# [ORG-IN-INSTRUMENTATION_PROBE-v0.1.0-P1-T01] Design Task 1

**Structure:** `[ORG-IN-INSTRUMENTATION_PROBE-v0.1.0-P1-`
**Layer:** Organelle
**Issue:** #471
...
The implementation of this issue satisfies all constitutional requirements for the `[ORG-IN-INSTRUMENTATION_PROBE-v0.1.0-P1-` structure at the Organelle layer. All invariants defined in the issue body have been verified and encoded into the artefact record.
